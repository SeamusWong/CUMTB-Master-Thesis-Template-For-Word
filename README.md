...
2. （此条已废弃，由于Word一些查因不明的Bug，重新以标准文档格式docx上传，对正常编辑没有影响可以和原来一样使用）本文档格式为dotx，为Microsoft Word模板文件，当打开这个文件后，Word会按照模板创建一个新文档并且在保存的时候提示选择新文件位置，所以在此文件上的所有编辑均不会影响到原模板文件。
...
6. 还有其他问题可以在issue中反馈，或者在discussion中讨论
...
- 表格设置了不分页，即保证整张表全部出现在一页当中，如果不想使用，那就修改表格样式中的段落，取消“与下段同页”的选项
- 文档中只有“图”“Fig.”“表”“Table”四个题注标签是使用的，其余的不要使用
- 如果有内容来源等注解要说明，和图片一样使用 11图注格式
...
- 简介和致谢跟随模板安排走就行，格式分别是： 26_1简介 作者姓名 26_2简介正文 26_3简介小标题 26_4简介列项
